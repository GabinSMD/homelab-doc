...
git clone homelab-config.bundle config-repo
git clone homelab-doc.bundle doc-repo    # ce runbook, hors ligne
...
# (Corrige le 2026-09-04 : cette etape faisait un `cp` vers
# /mnt/ssd/config/docker-compose.yml, chemin de l'ancienne disposition. Elle
# fabriquait un doublon a la racine au lieu de restaurer quoi que ce soit.)
