...
- **`restic` est en 0.14.0**, compilé en 2022 — toujours ouvert. La série
  courante est bien plus récente. Ça fonctionne, mais un outil de reprise après
  sinistre est le dernier endroit où laisser vieillir une version.
