...
!!! warning "Pas de CSP global"
    CSP retire du middleware global — casse les SPA (Beszel, Proxmox, Portainer). Voir [decisions.md](../decisions.md#security-headers--pas-de-csp-global-per-route-headers).
