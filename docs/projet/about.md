...
Ce site est généré avec [Docusaurus](https://docusaurus.io/) (migré depuis MkDocs Material le 2026-08-26, voir [le plan de migration](journal/2026-08-25-migration-docusaurus.md)) et déployé automatiquement sur GitHub Pages via GitHub Actions.
