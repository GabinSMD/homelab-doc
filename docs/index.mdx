...
# Un Raspberry Pi, deux ZimaBoards, une obsession du détail

Carnet de bord d'un homelab résidentiel : architecture, services auto-hébergés,
hardening, observabilité, runbooks. Tout ce que je remettrais en place si la
maison brûlait demain.

- **3 hosts** — penny + galahad + lancelot
- **SSO Authelia** — 12+ services derrière Traefik
- **Backups** — Restic vers R2 EU + PBS
- **Stack** — DietPi, Proxmox, Docker, sops/age
...
| Comprendre le réseau et le DNS | [Réseau actuel](architecture/reseau.mdx) |
...
| Restaurer après un crash | [Break-glass](operations/break-glass.mdx) |
